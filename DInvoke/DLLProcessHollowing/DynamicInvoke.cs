...
using static DLLProcessHollowing.Main;
...
namespace DLLProcessHollowing
{
    class DynamicInvoke
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        public delegate IntPtr ZwQueryInformationProcess(IntPtr hProcess, int procInformationClass, ref PROCESS_BASIC_INFORMATION procInformation, uint ProcInfoLen, ref uint retlen);
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
